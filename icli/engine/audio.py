"""Text-to-speech and sound alert client for the Awwdio service."""
...
httpxtimeout: httpx.Timeout = httpx.Timeout(0.333, connect=0.333, write=0.333, read=None)


@dataclass(slots=True)
class AwwdioClient:
    url: str | None = field(default_factory=lambda: os.getenv("ICLI_AWWDIO_URL", None))
    ...
    errorHistory: dict[str, float] = field(default_factory=dict)
